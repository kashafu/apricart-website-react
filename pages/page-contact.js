            ...
            {/* <div class="containerSS">
                ...
                <div class="row">
                    <div class="col-md-4 mb-4 mb-md-0">
                        <h4 class="mb-15 text-brand">Karachi Office</h4>
                        B-191, Block No. 5, Gulshan-e-Iqbal, <br/>
                        Karachi , Pakistan<br/>
                        <abbr title="Phone">Phone:</abbr>
                        (+92) - 304 - 111 -0195<br/>
                        <abbr title="Email">Email: </abbr><a href="#" class="__cf_email__" data-cfemail="#">support@apricart.pk</a><br/>
                    ...
                    <div class="col-md-4 mb-4 mb-md-0">
                        <h4 class="mb-15 text-brand">Islamabad Office</h4>
                      Sector I-9 <br/>
                    ...
                    <div class="col-md-4">
                        <h4 class="mb-15 text-brand">Peshawar Office</h4>
                        Hayatabad Phase 1<br/>
                       Chicago, 60601, USA<br/>
                        <abbr title="Phone">Phone:</abbr> 
                        (+92) - 304 - 111 -0195<br/>
                        <abbr title="Email">Email: </abbr><a href="#" class="__cf_email__" data-cfemail="#">support@apricart.pk</a><br/>
