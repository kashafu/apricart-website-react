		...
		<>
					...
					<section className="w-1/3">
						<div className="flex justify-evenly items-center w-full">
							<Link
								passHref
								href={
									"https://www.facebook.com/apricartonlinegrocery/"
								}
							>
								<svg
							...
							<Link
								passHref
								href={
									"https://twitter.com/apricartpk?lang=en    /"
								}
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
							...
							<Link
								passHref
								href={
									"https://pk.linkedin.com/company/apricartestores/"
								}
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
							...
							<Link
								passHref
								href={
									"https://www.instagram.com/apricart.pk/?hl=en/"
								}
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
			...
			<footer className="flex flex-col sm:hidden bg-main-grey-1000 py-12">
				...
				<section>
					...
					{/* Bangks */}
					<div className="flex justify-center items-center w-full px-2 pt-6">
						{redirectSourceSelector === 'js_bank' ? (
							<>
								<Link passHref href={""}>
									<Image
