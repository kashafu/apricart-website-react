       ...
       <footer className="footer-distributed">
         ...
         <div className="footer-right">
            ...
            <div className="footer-icons">
               ...
               <a href="https://www.facebook.com/apricartonlinegrocery/"><i className="fab fa-facebook"></i></a>
               <a href="https://twitter.com/apricartpk?lang=en"><i className="fab fa-twitter"></i></a>
               <a href="https://pk.linkedin.com/company/apricartestores"><i className="fab fa-linkedin"></i></a>
