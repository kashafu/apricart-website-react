	...
	return (
		<footer className="flex flex-col ">
			<div className="w-full flex justify-center items-center">
				<div className=" w-[80%] sm:w-1/5 ml-4 my-4 md:m-10">
					<Logo />
				</div>
			</div>
			<div className="flex flex-col sm:flex-row justify-between w-full ">
				<div className="w-full sm:w-1/2 flex flex-col md:px-4">
					<div className="px-2 inline-flex mb-4">
						...
						<h4 className=" px-2 text-main-blue font-nunito sm:text-xl text-base">
					...
					<div className=" px-2 inline-flex mb-4">
						...
						<h4 className=" px-2 text-main-blue font-lato sm:text-xl text-base">
							<strong>Phone: </strong>0304-1110195
						</h4>
					</div>
					...
					<div className="px-2 inline-flex mb-4">
						...
						<h4 className="px-2 text-main-blue font-lato sm:text-xl text-base">
							<strong>Email: </strong>support@apricart.pk
						</h4>
					</div>
				</div>
				{/* Divider Cart */}
				<div className="flex divide-x-2 divide-x-black">
					...
					{/* About Us Mobile */}
					<div className="w-1/2 text-center sm:hidden px-3 flex flex-col text-main-blue font-lato">
						<div>
							<Link passHref href={"/"}>
								<h2 className="cursor-pointer hover:brightness-[5] font-lato duration-300 text-2xl sm:text-3xl md:text-4xl pb-8">
									About Us
								</h2>
							</Link>
						</div>
						...
						<div className="flex flex-col mt-8 md:mt-0">
							<Link passHref href={"/privacy-policy"}>
								<p className="cursor-pointer hover:brightness-[5] font-lato text-base sm:text-lg md:text-xl duration-300">
									Privacy Policy
								</p>
							</Link>
						...
						<div className="flex justify-center items-center">
							<div className="px-2">
								<Link
									...
									passHref
								>
									<div className="w-[120px] h-[40px] sm:w-[180px] sm:h-[60px] md:w-[200px] md:h-[70px] my-6 relative cursor-pointer">
										<Image
											src={playstoreImg}
											layout="fill"
					...
					<div className="flex justify-center items-center w-full">
						...
						>
							<svg
								xmlns="http://www.w3.org/2000/svg"
								viewBox="0 0 448 512"
								className="w-8 mx-2  fill-main-blue cursor-pointer hover:brightness-[2] duration-300"
							>
