        ...
        <div>
            <div className="bg-gray-200 flex flex-col  text-indigo-900  p-8 w-full sm:flex-row sm:h-60">
                <div className="flex flex-col mx-4 text-indigo-900 justify-center items-center sm:w-4/12">
                    ...
                    <div className="flex flex-col h-1/4 my-1 justify-between items-center">
                        <div className="flex flex-row">
                            <i className="fa fa-map-marker"></i>
                            <p className="text-center">
                                <span className="font-bold">Address: </span>
                                <span>
                                    Office No 106, Emarah Suites, Main Shahrah e
                                    Faisal, Sindhi Muslim Cooperative Housing
                                    Society, Karachi
                                </span>
                            </p>
                        </div>
                ...
                <div className="inline-flex  h-1/4 my-1 justify-between items-center">
                    <Image
                        src="/assets/images/Group 72.svg"
                        width={40}
                        height={40}
                        // className="img-fluid"
                        alt=""
                ...
                <div className="inline-flex h-1/4 my-1 justify-center items-center">
                    <Image
                        src="/assets/images/Group 65.svg"
                        width={30}
                        height={30}
                        // className="img-fluid"
                        alt=""
                ...
                <div className="inline-flex h-1/4 my-1 justify-center items-center">
                    <Image
                        src="/assets/images/Group 68.svg"
                        width={40}
                        height={40}
                        // className="img-fluid"
                        alt=""
