					...
					<section className="w-1/2 ">
						<div className="md:w-full px-3 text-center text-main-blue font-nunito">
							<div className="flex flex-col sm:flex-col justify-center items-center md:mt-0">
								<select className="w-full">
									<option value="/">
										Address: Office No 601, Emarah Suites, Main
										Shahrah-e-Faisal, Opposite FTC, Karachi
									</option>
									<option value="/">Phone: 0304-1110195</option>
									<option value="/">Email: support@apricart.pk</option>
								</select>
							</div>
						</div>
					</section>
