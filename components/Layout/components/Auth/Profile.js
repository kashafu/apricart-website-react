...
export default function Profile() {
	...
	return (
		...
		>
			...
			<div
				className={
					"flex flex-col items-center absolute right-0 top-[45px] z-50 w-[200px] p-4 bg-slate-100 rounded-b-xl space-y-6 " + [showDropdown ? "animate-dropdown transition-none" : "opacity-0 duration-200 delay-1000 invisible"]
				}
			>
